...
if __name__ == "__main__":
    ...
    folder_path = os.path.join(PROJECT_PATH, "..", "ATLAS", "02a58871.blind")
    dirs = [
        d
    ...
    for dir_idx in range(len(dirs)):
        ...
        metadata_filename = [os.path.join(folder_path, "02a58871.blind")]
        ...
        if metadata_filename != []:
            ...
            # get metadata
            print(metadata_path)
            metadata_array = np.loadtxt(metadata_path, usecols=range(2, 74))
        ...
        for image_name_i in tqdm(image_file_names):
    ...
    print(np.array(only_numeric_metadata).shape)
    ...
    # save_pickle(data_dict, os.path.join(save_path, 'atlas_blind.pkl'))
    # plt.imshow(img)
    # plt.show()
