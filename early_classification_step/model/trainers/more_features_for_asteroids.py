...
if __name__ == "__main__":
    ...
    n_classes = 5
    params = {
        param_keys.RESULTS_FOLDER_NAME: "no_feat_best_model",
    ...
    #   model_name = 'DeepHitsFeat_EntropyRegBeta%.4f_batch%d_lr%.5f_droprate%.4f_inputsize%d_filtersize%d' % \
    ...
    trainer.train_model_n_times(
        DeepHiTSEntropyRegModel, params, train_times=N_TRAINS, model_name=model_name
    )
