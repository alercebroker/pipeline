...
from modules.iterators import train_iterator_with_features


class ValidationIteratorWithFeaturesBuilder(
    train_iterator_with_features.TrainIteratorWithFeaturesBuilder
):
    def __init__(
        self,
        params,
