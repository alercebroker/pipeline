...
class XGBoostClassifier(Classifier):
    ...
    def fit_from_features(
        ...
        self.model = xgb.XGBClassifier(tree_method="hist", early_stopping_rounds=3)
        ...
        self.model.fit(
            ...
            eval_set=[
                (
                    ...
                    validation_labels["astro_class_num"].values,
                )
            ],
        )
    ...
    def save_classifier(self, directory: str):
        ...
        with open(os.path.join(directory, "xgboost.pkl"), "wb") as f:
            pickle.dump(
                {
