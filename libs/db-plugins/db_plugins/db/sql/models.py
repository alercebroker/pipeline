...
class ForcedPhotometry(Base):
    ...
    # extra fields
    diffmaglim = Column(Float)
    pdiffimfilename = Column(String)
    programpi = Column(String)
    programid = Column(Integer)
    tblid = Column(Integer)
    nid = Column(Integer)
    rcid = Column(Integer)
    ...
    rfid = Column(Integer)
    jdstartref = Column(Float)
    jdendref = Column(Float)
