...
class LsstDetection(Base):
    ...
    trailNdata = Column(SmallInteger)
    ...
    dipoleNdata = Column(SmallInteger)
...
class ZtfNonDetection(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("oid", "mjd", "sid", name="pk_oid_mjd"),
...
class LsstNonDetection(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("oid", "mjd", "sid", name="pk_lsstnondetection_oid_mjd"),
