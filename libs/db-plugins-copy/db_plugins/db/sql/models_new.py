...
class Object(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_object_lastmjd", "latsmjd", postgresql_using="btree"),
...
class Detection(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('oid', 'measurement_id', name='pk_oid_measurementid'),
        ForeignKeyConstraint([oid], [Object.oid]),
        Index("ix_ndetection_oid", "oid", postgresql_using="hash") ### Puede ser btree u otro tipo...
    )
...
class ZtfDetection(Base):
    ...
    __table_args__ = ( ### Esto debe revisarse, puede ser otro indice
        PrimaryKeyConstraint('oid', 'measurement_id', name='pk_oid_measurementid'),
        ForeignKeyConstraint([oid], [Object.oid]),
