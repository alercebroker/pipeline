...
class LitData(L.LightningDataModule):
    ...
    def train_dataloader(self):
        return get_dataloader(dataset_used=self.train_dataset, batch_size=self.batch_size, set_type="train")

    def val_dataloader(self):
        return get_dataloader(dataset_used=self.val_dataset, batch_size=self.batch_size, set_type="validation")
    ...
    def test_dataloader(self):
        ...
        for time_to_eval in self.list_time_to_eval:
            ...
            dataloaders.append(get_dataloader(dataset, batch_size=self.batch_size, set_type="test"))
        return dataloaders
    ...
    def predict_dataloader(self, stage='test'):
        if stage == 'train':
            ...
            return get_dataloader(dataset_used=self.test_dataset, batch_size=self.batch_size, set_type="test")
