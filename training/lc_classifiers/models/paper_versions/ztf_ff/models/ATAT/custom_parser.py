...
def parse_model_args(arg_dict=None):
    ...
    parser.add_argument("--experiment_type_general", type=str, default="lc_md_feat_mta")
    parser.add_argument("--experiment_name_general", type=str, default="")
    parser.add_argument("--experiment_phase_general", type=str, default="")
    ...
    parser.add_argument("--use_emb_x_band", action="store_true", default=False)
    ...
    parser.add_argument("--entropy_beta_general", type=float, default=0.0)
    parser.add_argument("--label_smoothing_general", type=float, default=0.0)
    parser.add_argument(
    ...
    parser.add_argument("--qt_type_general", type=str, default="qt_global")  
