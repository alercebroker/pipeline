...
def run_with_hyperparams(path_features, path_partition, path_objects, folds_to_run, param_grid):
    ...
    for trial_idx, config in enumerate(param_combinations):
        ...
        for fold in folds_to_run:
            ...
            # Train and evaluate
            train_and_evaluate(classifier, features, shorten, partitions, config, trial_dir, fold)
...
def train_and_evaluate(
    ...
    test_probs.to_parquet(os.path.join(path_save, f"predictions_test.parquet"))
...
if __name__ == "__main__":
    ...
    param_grid = {
        ...
        "max_depth": [10, 20, 50],  # Profundidad máxima del árbol (None significa sin límite) # , 100, None
        "n_jobs": [8],
        "verbose": [11],
    }
