...
--experiment_name_general "model with paula classes, partition keep test" \
--data_root_general data/ztf_forced_photometry/processed/ds_pre241209_pos250117_detff_paula_keep_test \
--num_encoders 3 \
--embedding_size 192 \
