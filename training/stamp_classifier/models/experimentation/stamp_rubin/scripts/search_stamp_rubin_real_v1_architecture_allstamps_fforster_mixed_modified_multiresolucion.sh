...
export HYDRA_CONFIG_NAME="cnn_config_v1_real_rubin_allstamps_fforster_mixed_modified_normIgnacio_multiresolucion"
...
TRAINING_SCRIPT="training_tf_custom_mr.py" 
