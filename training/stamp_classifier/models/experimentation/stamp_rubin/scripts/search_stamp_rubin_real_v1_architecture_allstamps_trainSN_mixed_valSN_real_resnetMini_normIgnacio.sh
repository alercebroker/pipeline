...
export HYDRA_CONFIG_NAME="cnn_config_v1_real_rubin_allstamps_trainSN_mixed_valSN_real_resnet_custom_mini_normIgnacio"
...
exp_desc="rubin_gridsearch_quick_resnetmini_norm_ignacio"
...
for lr in "${learning_rates[@]}"; do
  for dropout in "${dropout_rates[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES="MIG-802fb5a9-d98a-5bce-ad53-9227189dc2cf" python ${TRAINING_SCRIPT} \
      ...
      stamp_classifier.loader.stamp_norm_type='legacy' \
