...
dia_source_schema: dict[str, DType] = {
    ...
    "trailAlgorithm": pd.Int32Dtype(),
    "trail_flag_edge": pd.BooleanDtype(),
    "trail_flag": pd.BooleanDtype(),
    ...
    "reliabilityVersion": pd.StringDtype(),
    "band": pd.Int32Dtype(),
...
mpc_orbits_schema: dict[str, DType] = {
    ...
    "nopp": pd.Int32Dtype(),
    "nobs_total": pd.Int32Dtype(),
    "nobs_total_sel": pd.Int32Dtype(),
    "arc_length_total": pd.Float64Dtype(),
    "arc_length_sel": pd.Float64Dtype(),
    "a": pd.Float64Dtype(),
    "q": pd.Float64Dtype(),
    "e": pd.Float64Dtype(),
    "i": pd.Float64Dtype(),
    "node": pd.Float64Dtype(),
    "argperi": pd.Float64Dtype(),
    "peri_time": pd.Float64Dtype(),
    "mean_anomaly": pd.Float64Dtype(),
    "period": pd.Float64Dtype(),
    "mean_motion": pd.Float64Dtype(),
    "epoch_mjd": pd.Float64Dtype(),
    "yarkovsky": pd.Float64Dtype(),
    "srp": pd.Float64Dtype(),
    "a1": pd.Float64Dtype(),
    "a2": pd.Float64Dtype(),
    "a3": pd.Float64Dtype(),
    "dt": pd.Float64Dtype(),
    "a_unc": pd.Float64Dtype(),
    "q_unc": pd.Float64Dtype(),
    "e_unc": pd.Float64Dtype(),
    "i_unc": pd.Float64Dtype(),
    "node_unc": pd.Float64Dtype(),
    "argperi_unc": pd.Float64Dtype(),
    "peri_time_unc": pd.Float64Dtype(),
    "yarkovsky_unc": pd.Float64Dtype(),
    "srp_unc": pd.Float64Dtype(),
    "a1_unc": pd.Float64Dtype(),
    "a2_unc": pd.Float64Dtype(),
    "a3_unc": pd.Float64Dtype(),
    "dt_unc": pd.Float64Dtype(),
    "mean_anomaly_unc": pd.Float64Dtype(),
    "period_unc": pd.Float64Dtype(),
    "mean_motion_unc": pd.Float64Dtype(),
    "h": pd.Float64Dtype(),
    "g": pd.Float64Dtype(),
