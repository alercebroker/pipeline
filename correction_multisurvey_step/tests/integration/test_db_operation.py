...
class TestCorrectionMultisurveyZTF(unittest.TestCase):
    ...
    def message_validation(data):
        ...
        print(
            TestCorrectionMultisurveyZTF.validate_alert_fields_message(data),
            TestCorrectionMultisurveyZTF.validate_non_detection_fields_message(data),
            TestCorrectionMultisurveyZTF.validate_detection_fields_message(data),
        )
        return (
            TestCorrectionMultisurveyZTF.validate_alert_fields_message(data)  # True
            and TestCorrectionMultisurveyZTF.validate_non_detection_fields_message(data)  # False
            and TestCorrectionMultisurveyZTF.validate_detection_fields_message(data)  # False
        )
