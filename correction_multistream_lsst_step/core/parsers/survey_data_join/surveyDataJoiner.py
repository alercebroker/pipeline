...
class SurveyDataJoiner(ABC):
    ...
    #TODO make the logging inside the joiner instead of at the step.py level
    @abstractmethod
    def add_data_logging(self, combined_data: Dict[str, pd.DataFrame]) -> Dict[str, pd.DataFrame]:
        """
        Add data with count of new data to log after processing
