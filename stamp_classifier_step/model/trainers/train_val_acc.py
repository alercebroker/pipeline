...
if __name__ == "__main__":
    ...
    n_classes = 5
    params = {
        param_keys.RESULTS_FOLDER_NAME: "val_acc_loss2",
        ...
        param_keys.VALIDATION_MONITOR: general_keys.ACCURACY,
        param_keys.VALIDATION_MODE: general_keys.MAX,
    }
    ...
    trainer.train_model_n_times(
        ...
        params,
        train_times=10,
        model_name="DHNan0NormStampWBogusCropValAcc",
    )
