...
if __name__ == "__main__":
    ...
    params = {
        param_keys.RESULTS_FOLDER_NAME: "dh_nans_norms",
    ...
    trainer.train_model_n_times(
        DeepHiTS4ClassModel, params, train_times=10, model_name="DH4Class"
    )

    trainer.train_model_n_times(
        DeepHiTS4ClassModelNan, params, train_times=10, model_name="DH4ClassNan"
    )
    ...
    trainer.train_model_n_times(
        ...
        params,
        train_times=10,
        model_name="DH4ClassNanNormStamp",
    )
