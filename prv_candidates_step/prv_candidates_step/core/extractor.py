...
class PreviousCandidatesExtractor:
    ...
    def extract_all(self):
        ...
        for alert in self._alerts:
            ...
            alert.update({"has_stamp": bool(alert.pop("stamps", False)), "forced": False, "parent_candid": None})
            ...
            try:
                ...
                messages.append(out)
                self.logger.debug(msg.format(len(out["detections"]) - 1, len(out["non_detections"]), alert["aid"]))
        return messages
