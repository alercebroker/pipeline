...
from late_classification.step import LateClassifier
from late_classification.step import SQLConnection
from late_classification.step import KafkaProducer
from late_classification.step import pd
from late_classification.step import np
...
class StepTestCase(unittest.TestCase):
    ...
    def test_execute_with_producer(self, mock_insert):
